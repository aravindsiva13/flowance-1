...
// lib/data/services/mock_api_service.dart - Updated with Time Tracking
...
class MockApiService {
  ...
  // [Previous auth, user, project, task, comment, and notification methods remain the same...]
  ...
  // [All existing auth, user, project, task, comment, and notification methods remain unchanged]
  // Auth Methods
  Future<Map<String, dynamic>> login(String email, String password) async {
    await Future.delayed(const Duration(milliseconds: 500));
    _initializeData();
  ...
  Future<TaskModel> createTask(Map<String, dynamic> data) async {
    ...
    final newTask = TaskModel(
      ...
      isTimeTrackingEnabled: data['isTimeTrackingEnabled'] ?? true,
    );
  ...
  // [Rest of the existing methods: Comment, Notification, Dashboard methods remain the same...]
